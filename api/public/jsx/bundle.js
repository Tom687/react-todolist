        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success' || res.status === 200) {
              // TODO : Un ou l'autre ou les 2 ?
              (0, _alerts.showAlert)('success', 'Succès. Redirection en cours…');
          ...
          case 7:
            ...
            if (_context.t0.response.data.message) (0, _alerts.showAlert)('error', _context.t0.response.data.message); // TODO : Checker d'abord l'existance de err.res.data.msg ?
            else (0, _alerts.showAlert)('error', 'Mauvais identifiantss');
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"todos.js":[function(require,module,exports) {
"use strict";
...
var insertTodo = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('http://localhost:3000/todos', {
              title: title // TODO : createdOn ici ?
          ...
          case 3:
            ...
            if (res.data.status === 'success' || res.status === 200) {
              // TODO : Un ou l'autre ou les 2 ?
              (0, _alerts.showAlert)('success', 'Todo ajouté avec succès !');
              /*window.setTimeout(() => {
              	location.assign('/todos');
              }, 2000);*/
            }
          ...
          case 7:
            ...
            console.log('ERR', _context.t0.response);
            if (_context.t0.response.data.message) (0, _alerts.showAlert)('error', _context.t0.response.data.message); // TODO : Checker d'abord l'existance de err.res.data.msg ?
            else (0, _alerts.showAlert)('error', 'ERREUR TODO');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (event) {
    ...
    if (!email) {
      alert.innerText = 'Email'; //showAlert('Error', 'Email non saisi');
    }

    if (!password) {
      alert.innerText = 'MDP'; //showAlert()
    }
